...
public class tcp_echo_client_file {
    public static void main(String[] args) throws Exception{
        ...
        //added to send multiple packets
        byte[] data = new byte[1024];
        int bytesRead = 0;
        while((bytesRead = fis.read(data)) != -1){
            //reads the data from 0 to bytes read
            ByteBuffer buffer = ByteBuffer.wrap(data, 0, bytesRead); //makes message turn into bytes for the server to understand
